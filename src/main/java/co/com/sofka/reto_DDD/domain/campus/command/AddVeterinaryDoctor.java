...
public class AddVeterinaryDoctor extends Command {
    ...
    public AddVeterinaryDoctor(CampusId campusId, VeterinaryDoctorId veterinaryDoctorId, Name name, Addres addres, EmailAddres emailAddres, CellPhoneNumber cellPhoneNumber) {
