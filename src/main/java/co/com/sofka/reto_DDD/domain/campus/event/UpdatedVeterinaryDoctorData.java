...
public class UpdatedVeterinaryDoctorData extends DomainEvent {
   ...
   private final CellPhoneNumber cellPhoneNumber;
    ...
    public UpdatedVeterinaryDoctorData(VeterinaryDoctorId veterinaryDoctorId, Name name, Addres addres, EmailAddres emailAddres, CellPhoneNumber cellPhoneNumber) {
        super("sofka.campus.updatedveterinarydoctorData");
